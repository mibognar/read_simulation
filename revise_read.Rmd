...
combined_roc_plot_large %>% ggplot(aes(x = FPR, y = TPR, group = model_id, color = model_id)) +
  ...
  labs(x = "False Positive Rate (FPR)",
       ...
       color = "Model") +
  scale_x_continuous(limits = c(0,.15),breaks = c(0, .025, .05, .1, .15))+
  scale_y_continuous(limits = c(0,1.1), breaks = c(0, .2, .4, .6, .8, 1))+
  papaja::theme_apa()
...
combined_roc_plot_filters %>% ggplot(aes(x = FPR, y = TPR, group = filter_type, color = filter_type)) +
  ...
  labs(x = "False Positive Rate (FPR)",
       y = "True Positive Rate (TPR)",
       color = "Model") +
  scale_x_continuous(limits = c(0,.2),breaks = c(0, .025, .05, .1, .15))+
  scale_y_continuous(limits = c(0,1.2), breaks = c(0, .2, .4, .6, .8, 1))+
  papaja::theme_apa()
...
ggsave("ROC_all_small.png", dpi = 600, width = 8, height = 6)
```
...
ggsave("ROC_nofilter_small.png", dpi = 600, width = 8, height = 6)
```
...
combined_roc_plot_small_3SD %>% ggplot(aes(y = FPR, x = TPR, group = model_id, color = model_id)) +
  geom_hline(yintercept = 0.025, linetype = "dashed", color = "grey", alpha=.6)+
  geom_path() +
  geom_point() +
  ggrepel::geom_text_repel(aes(label = participants), size = 2.5, max.overlaps = 10, show.legend = FALSE, segment.color = NA, min.segment.length = 0.2) +
  scale_color_manual(name = "Model Type", 
  ...
  labs(y = "False Positive Rate (FPR)",
       ...
       color = "Model") +
  scale_y_continuous(limits = c(0,.15),breaks = c(0, .025, .05, .1, .15))+
  scale_x_continuous(limits = c(0,1.1), breaks = c(0, .2, .4, .6, .8, 1))+
  papaja::theme_apa()
ggsave("ROC_3_small_horizontal.png", dpi = 600, width = 8, height = 6)
```
